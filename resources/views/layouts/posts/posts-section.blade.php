<section
    @if(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) === '/')
        class="posts-section mb-2 flex-column"
    @else
        class="posts-section mb-2 flex-column flex-sm-row col-12 col-sm-8 col-lg-10 order-2 order-sm-0"
    @endif >
    <h3 class="posts-section__header col-12 text-center">Latest posts</h3>
